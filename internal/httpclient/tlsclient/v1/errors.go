...
// ProviderID identifies this integration major, not a configured instance.
const ProviderID = "httpclient.tlsclient.v1"
const (
...
func (private) Format(state fmt.State, _ rune) { _, _ = io.WriteString(state, "tlsclient[restricted]") }
