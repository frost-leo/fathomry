...
type (
	...
	ClientActivityExecutionDescription struct {
		fathomryScope    *fathomryDecoderScope
		fathomryDecodeMu *fathomryDecodeMutex
...
func (d *ClientActivityExecutionDescription) fathomryGetHeartbeatDetails(valuePtrs ...any) error {
...
func (d *ClientActivityExecutionDescription) fathomryGetInput(valuePtrs ...any) error {
...
func (d *ClientActivityExecutionDescription) fathomryGetResult(valuePtr any) error {
...
func (d *ClientActivityExecutionDescription) fathomryGetOutcomeFailure() error {
...
func (d *ClientActivityExecutionDescription) fathomryGetLastFailure() error {
...
func (d *ClientActivityExecutionDescription) fathomryGetSummary() (string, error) {
	if d.summary != "" {
...
// Uses the data converter of the client used to make the Describe call. Returns error if data conversion fails.
func (d *ClientActivityExecutionDescription) fathomryGetStaticDetails() (string, error) {
	if d.staticDetails != "" {
