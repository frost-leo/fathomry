...
type Cache interface {
	...
	// DeleteIf removes only the matching comparable value, preserving a newer
	// entry another worker may have installed under the same key.
	DeleteIf(key string, expected any)
