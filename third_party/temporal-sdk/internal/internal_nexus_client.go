...
//
// NOTE: Experimental
func (d *ClientNexusOperationExecutionDescription) fathomryGetSummary() (string, error) {
...
//
// NOTE: Experimental
func (d *ClientNexusOperationExecutionDescription) fathomryGetLastAttemptFailure() error {
...
//
// NOTE: Experimental
func (c *ClientNexusOperationCancellationInfo) fathomryGetLastAttemptFailure() error {
