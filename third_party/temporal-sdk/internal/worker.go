...
type (
	...
	WorkerOptions struct {
		// FathomryLifecycleV1 enables the local ownership/join extension. It does
		// not change Stop's timeout or the result of any Workflow or Activity.
		FathomryLifecycleV1 bool
