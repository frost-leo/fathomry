...
type TransportParameterOrderMode = wire.TransportParameterOrderMode

const (
	// TransportParameterOrderDefault uses the default quic-go ordering
	TransportParameterOrderDefault TransportParameterOrderMode = wire.TransportParameterOrderDefault
	// TransportParameterOrderChrome mimics Chrome's transport parameter ordering
	TransportParameterOrderChrome TransportParameterOrderMode = wire.TransportParameterOrderChrome
	// TransportParameterOrderFirefox mimics Firefox's transport parameter ordering
	TransportParameterOrderFirefox TransportParameterOrderMode = wire.TransportParameterOrderFirefox
	// TransportParameterOrderCustom uses a custom order specified in CustomTransportParameterOrder
	TransportParameterOrderCustom TransportParameterOrderMode = wire.TransportParameterOrderCustom
)
...
type Config struct {
	...
	// Options:
	// - TransportParameterOrderDefault (0): Use default quic-go ordering
	// - TransportParameterOrderChrome (1): Use Chrome's transport parameter order
	// - TransportParameterOrderFirefox (2): Use Firefox's transport parameter order
	// - TransportParameterOrderCustom (3): Use custom order specified in CustomTransportParameterOrder
	TransportParameterOrder TransportParameterOrderMode
