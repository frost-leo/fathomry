...
// HTTP3Forced reports the native per-request selection without exposing its key.
func HTTP3Forced(ctx context.Context) bool { return forceHTTP3FromContext(ctx) }
